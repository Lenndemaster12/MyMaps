document.addEventListener("DOMContentLoaded", () => {
    ...
    Papa.parse("api/events_geocoded.csv", {
        ...
        complete: function(results) {
            ...
            // Functie om elke eerste letter van een woord hoofdletter te maken
            ...
            function createCard(e, isPast=false) {
                ...
                card.innerHTML = `
                    ...
                    <p class="routedescription">${capitalizeWords(e.title) || "Geen titel"}</p>
                    <p class="routename">${address}</p>
                    <p><i class="ri-calendar-event-line"></i> ${formattedDate} van ${formattedStart} - ${formattedEnd}</p>
                    <p><i class="ri-money-dollar-circle-line"></i> €${price}</p>
